...
namespace VRLab.AnchorStore
{
    ...
    public class GlobalPersistanceScriptable : ScriptableObject
    {
        ...
        [SerializeField]
        public List<string> CurrentProjectTags;
        [SerializeField]
        [ShowOnly]public List<(string, string)> AnchorTagsAndNamesInStoreForThisProject;
        [SerializeField]
        [ShowOnly]public List<string> RawAnchorNamesInStoreOnLastUpdate;
        [SerializeField]
        [ShowOnly]public List<string> AnchorTagsInStore;

        [Header("Anchor Data")]
        [SerializeField]
        [ShowOnly]public List<PersistantAnchorData> AvailableAnchorDataForProject;

        [SerializeField]
        private List<string> latestAnchorStorePersistedNames;

        [Header("Added and Removed Anchors")]
        [SerializeField]
        [ShowOnly]public List<string> RawAnchorNamesRemovedFromStore;
        [SerializeField]
        [ShowOnly]public List<string> RawAnchorNamesAddedFromStore;
        [Header("Added and Removed Anchors")]
        [SerializeField]
        [ShowOnly]public List<string> AnchorTagsRemovedFromStore;
        [SerializeField]
        [ShowOnly]public List<string> AnchorTagsAddedFromStore;
        ...
        {
            RawAnchorNamesAddedFromStore.Clear();
            RawAnchorNamesRemovedFromStore.Clear();
            RawAnchorNamesInStoreOnLastUpdate.Clear();
            AnchorTagsInStore.Clear();
            AnchorTagsAddedFromStore.Clear();
            AnchorTagsRemovedFromStore.Clear();
        }
