...
namespace VRLab.AnchorStore
{
    ...
    public class PersistableAnchorControls : MonoBehaviour
    {
        [SerializeField]
        ...
        /// </summary>
        public Func<PersistableAnchorControls, string> AnchorTextFormatter { get; set; }

        private string DefaultAnchorTextFormatter(PersistableAnchorControls visuals)
        {
        ...
        private PersistableAnchorControls()
        {
